...
<form method="get" action="/backend/archiv" class="filter-bar" data-auto-filter>
    ...
    <div class="filter-row">
        ...
        <a href="/backend/archiv" class="filter-reset <?= $hasFilters ? '' : 'filter-reset-inactive' ?>">× zurücksetzen</a>
    </div>
</form>

<div id="list-results">
<?php require ROOT . '/app/Views/backend/evaluation/_archive_list.php' ?>
</div>
